...
class yolov5_heatmap:
    def __init__(self, weight, cfg, device, method, layer, backward_type, conf_threshold, ratio):
        ...
        colors = np.random.uniform(0, 255, size=(len(model_names), 3)).astype(np.float16)
...
def get_params():
    params = {
        'weight': '/root/yolov5/runs/train/s_w16_b32_e200/weights/best.pt',
...
if __name__ == '__main__':
    ...
    model("/root/autodl-tmp/datasets_new/images/val/000_br0.7_th0.05.jpg", 'result')
