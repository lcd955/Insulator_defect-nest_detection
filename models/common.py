...
#         super().__init__()
#         if groups is None:
#             groups = in_channels  # Default groups value is same as in_channels
#         self.depthwise = nn.Conv2d(in_channels, in_channels, kernel_size, stride, padding, groups=groups, bias=False)
